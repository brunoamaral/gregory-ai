...
**Environment**: Managed via `docker-compose.yaml` + `.env` file. Critical vars: `FERNET_SECRET_KEY` (for encrypted fields), `ORCID_ClientID/Secret`, `EMAIL_*` (Postmark), `POSTGRES_*`.
