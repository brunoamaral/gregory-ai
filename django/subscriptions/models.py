...
class Subscribers(models.Model):
	...
	active = models.BooleanField(
		...
		help_text=(
			...
			"Per-list opt-outs do NOT change this flag. Note: subscriber analytics counts "
			"someone as 'active' when they hold at least one active list subscription, not "
			"by this flag, so the two numbers can differ."
		),
	)
