...
def _initialize_model() -> tuple[
	BartForConditionalGeneration, BartTokenizer, torch.device
]:
	"""
...
def validate_summary_usage(
	text: str, summary: str, usage_type: str = "training"
) -> bool:
	"""
	...
	if usage_type == "training":
		...
		if not is_cached:
			logging.warning(
				f"Generated a new summary for training that wasn't in the cache. "
