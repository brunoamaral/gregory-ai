...
class Verboser:
	...
	def info(
		self, message: str, min_level: VerbosityLevel = VerbosityLevel.PROGRESS
	) -> None:
		"""
	...
	def warn(
		self, message: str, min_level: VerbosityLevel = VerbosityLevel.WARNINGS
	) -> None:
		"""
	...
	def summary(
		self, table: str, min_level: VerbosityLevel = VerbosityLevel.SUMMARY
	) -> None:
		"""
