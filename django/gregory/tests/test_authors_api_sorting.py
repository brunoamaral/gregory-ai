...
class AuthorsAPISortingTestCase(TestCase):
	...
	def setUp(self):
		...
		self.organization = Organization.objects.create(
			name="Test Organization", slug="sorting-org"
		)
		...
		self.team1 = Team.objects.create(
			name="Test Team 1", slug="test-team-1", organization=self.organization
		)
		...
		self.author_high = Authors.objects.create(
			given_name="High", family_name="ArticleCount", full_name="High ArticleCount"
		)
		...
		self.author_low = Authors.objects.create(
			given_name="Low", family_name="ArticleCount", full_name="Low ArticleCount"
		)
	...
	def test_sorting_without_filters(self):
		...
		url = reverse("authors-list")
		params = {"sort_by": "article_count", "order": "desc", "format": "json"}
	...
	def test_sorting_stability_with_equal_counts(self):
		...
		author_equal1 = Authors.objects.create(
			given_name="Equal1", family_name="Count", full_name="Equal1 Count"
		)

		author_equal2 = Authors.objects.create(
			given_name="Equal2", family_name="Count", full_name="Equal2 Count"
		)
