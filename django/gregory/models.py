...
class SponsorMergeCandidate(models.Model):
	...
	sponsor_a = models.ForeignKey(Sponsor, related_name="+", on_delete=models.CASCADE)
	sponsor_b = models.ForeignKey(Sponsor, related_name="+", on_delete=models.CASCADE)
	basis = models.CharField(max_length=20)  # "suffix_variant" | "containment"
	shared_key = models.CharField(max_length=500)  # the fold key / shared prefix
	status = models.CharField(max_length=10, default="pending")  # pending|merged|dismissed
