...
class Trials(models.Model):
	...
	inclusion_gender = models.CharField(max_length=100,null=True,blank=True)
	date_enrollement = models.DateField(null=True,blank=True)
	target_size = models.CharField(max_length=100,null=True,blank=True)
	study_type = models.CharField(max_length=150,null=True,blank=True)
	...
	contact_tel = models.CharField(max_length=150,null=True,blank=True)
	...
	secondary_id = models.CharField(max_length=150,null=True,blank=True)
	source_support = models.TextField(max_length=100,null=True,blank=True)
