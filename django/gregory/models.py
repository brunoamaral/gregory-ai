...
class Trials(models.Model):
	...
	internal_number = models.CharField(max_length=20,null=True)
	last_refreshed_on = models.DateField(null=True)
	scientific_title = models.TextField(null=True)
	primary_sponsor = models.TextField(null=True)
	retrospective_flag = models.CharField(max_length=3,null=True)  # Assuming 'Yes' or 'No'
	...
	source_register = models.CharField(max_length=50,null=True)
	# web_address = models.URLField(null=True)
	recruitment_status = models.CharField(max_length=50,null=True)
	other_records = models.CharField(max_length=3,null=True)  # Assuming 'Yes' or 'No'
	...
	inclusion_gender = models.CharField(max_length=100,null=True)
	date_enrollement = models.DateField(null=True)
	target_size = models.CharField(max_length=100,null=True)
	study_type = models.CharField(max_length=150,null=True)
	study_design = models.TextField(null=True)
	phase = models.TextField(null=True)
	countries = models.TextField(null=True)
	contact_firstname = models.CharField(max_length=150,null=True)
	contact_lastname = models.TextField(null=True)
	contact_address = models.TextField(null=True)
	contact_email = models.EmailField(null=True,max_length=500)
	contact_tel = models.CharField(max_length=150,null=True)
	...
	primary_outcome = models.TextField(null=True)
	secondary_outcome = models.TextField(null=True)
	secondary_id = models.CharField(max_length=150,null=True)
	source_support = models.TextField(max_length=100,null=True)
	ethics_review_status = models.TextField(null=True)
	ethics_review_approval_date = models.DateField(null=True)
	ethics_review_contact_name = models.EmailField(null=True,max_length=500)
	ethics_review_contact_address = models.TextField(null=True)
	ethics_review_contact_phone = models.CharField(max_length=50,null=True)
	ethics_review_contact_email = models.EmailField(null=True,max_length=500)
